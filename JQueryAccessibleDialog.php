...
function JQueryAccessibleDialog_init() {
    ...
    if ( !is_admin() && is_active_widget('widget_JQueryAccessibleDialog') ) {
        wp_register_style('jquery.ui.all', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleDialog/lib/jquery-ui/themes/base/jquery.ui.all.css'));
        wp_enqueue_style('jquery.ui.all');

        wp_deregister_script('jquery');

        // add your own script
        wp_register_script('jquery-1.4.2', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleDialog/lib/jquery-ui/jquery-1.4.2.js'));
        wp_enqueue_script('jquery-1.4.2');

        wp_register_script('jquery.ui.core.js', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleDialog/lib/jquery-ui/ui/jquery.ui.core.js'));
        wp_enqueue_script('jquery.ui.core.js');

        wp_register_script('jquery.ui.widget', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleDialog/lib/jquery-ui/ui/jquery.ui.widget.js'));
        wp_enqueue_script('jquery.ui.widget');

        wp_register_script('jquery.ui.mouse', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleDialog/lib/jquery-ui/ui/jquery.ui.mouse.js'));
        wp_enqueue_script('jquery.ui.mouse');

        wp_register_script('jquery.ui.button', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleDialog/lib/jquery-ui/ui/jquery.ui.button.js'));
        wp_enqueue_script('jquery.ui.button');

        wp_register_script('jquery.ui.draggable', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleDialog/lib/jquery-ui/ui/jquery.ui.draggable.js'));
        wp_enqueue_script('jquery.ui.draggable');

        wp_register_script('jquery.ui.position', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleDialog/lib/jquery-ui/ui/jquery.ui.position.js'));
        wp_enqueue_script('jquery.ui.position');

        wp_register_script('jquery.ui.resizable', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleDialog/lib/jquery-ui/ui/jquery.ui.resizable.js'));
        wp_enqueue_script('jquery.ui.resizable');

        wp_register_script('jquery.ui.dialog', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleDialog/lib/jquery-ui/ui/jquery.ui.dialog.js'));
        wp_enqueue_script('jquery.ui.dialog');

        wp_register_script('jquery.effects.core', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleDialog/lib/jquery-ui/ui/jquery.effects.core.js'));
        wp_enqueue_script('jquery.effects.core');

        wp_register_script('jquery.ui.accordion', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleDialog/lib/jquery-ui/ui/jquery.ui.accordion.js'));
        wp_enqueue_script('jquery.ui.accordion');

        wp_register_script('jquery.ui.checkbox', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleDialog/lib/jquery-ui/ui/jquery.ui.checkbox.js'));
        wp_enqueue_script('jquery.ui.checkbox');

        wp_register_style('demos', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleDialog/lib/jquery-ui/demos.css'));
        wp_enqueue_style('demos');

        wp_register_style('JQueryAccessibleDialog_css', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleDialog/lib/JQueryAccessibleDialog.css'));
        wp_enqueue_style('JQueryAccessibleDialog_css');

        wp_register_script('JQueryAccessibleDialog', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleDialog/lib/JQueryAccessibleDialog.js'));
